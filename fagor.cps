...
description = "GitHub - Generic FAGOR";
vendor = "Autodesk, Inc.";
...
function onCyclePoint(x, y, z) {
  if (isFirstCyclePoint()) {
    ...
    case "chip-breaking":
      writeBlock(
        gRetractModal.format(98), gAbsIncModal.format(90), gMotionModal.format(69),
        getCommonCycle(x, y, cycle.retract, cycle.bottom),
...
function onCircular(clockwise, cx, cy, cz, x, y, z, feed) {
  ...
  if (isFullCircle()) {
    ...
    case PLANE_XY:
      ...
      writeBlock(gAbsIncModal.format(90), conditional(!properties.useG16, gPlaneModal.format(17)), gMotionModal.format(clockwise ? 2 : 3), xOutput.format(x), yOutput.format(y), zOutput.format(z), iOutput.format(cx - start.x, 0), jOutput.format(cy - start.y, 0), feedOutput.format(feed));
      break;
    case PLANE_ZX:
      if (properties.useG16) {
        writeBlock(getG16("ZX"));
