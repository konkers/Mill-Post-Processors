/**
  ...
  $Revision: 35629 $
  $Date: 2013-11-17 17:32:25 +0100 (sø, 17 nov 2013) $
  
  FORKID {6B5CC843-2BF6-484f-A55D-74B1506FBCFF}
*/

description = "GitHub - Generic Thermwood";
vendor = "Autodesk, Inc.";
...
function onSection() {
  ...
  if (insertToolCall || retracted) {
    ...
    if (!machineConfiguration.isHeadConfiguration()) {
      ...
      writeBlock(gMotionModal.format(0), gFormat.format(44), zOutput.format(initialPosition.z));
    } else {
      writeBlock(
        gAbsIncModal.format(90),
        gMotionModal.format(0),
...
function onClose() {
  ...
  writeBlock(gFormat.format(990)); // use machine coordinates
  currentWorkOffset = undefined;
